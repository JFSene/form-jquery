    ...
    $(".validate").submit(function(e) {
      ...
      $(this).find(".required").each(function(i, elm) {
        ...
        if ($(this).attr("minlength") && $(this).hasClass("required")) {
          if ($.trim($(this).val()).length < $(this).attr("minlength")) {
            ...
            $(this)
              .parent()
              .find("span")
              .html(minMsg.replace(/X/g, $(this).attr("minlength")))
              .fadeOut(500)
              .fadeIn(500)
              .fadeOut(500)
              .fadeIn(500);
        ...
        if ($(elm).hasClass("required") && $(elm).hasClass("cep")) {
          ...
          if (cepr.resultado == 0) {
            ...
            $(this)
              .parent()
              .find("span")
              .html("Cep n�o encontrado, informe um CEP v�lido.")
              .fadeOut(500)
              .fadeIn(500)
              .fadeOut(500)
              .fadeIn(500);
        ...
        if ($(this).attr("maxlength") && $(this).hasClass("required")) {
          if ($.trim($(this).val()).length > $(this).attr("maxlength")) {
            ...
            $(this)
              .parent()
              .find("span")
              .html(maxMsg.replace(/X/g, $(this).attr("maxlength")))
              .fadeOut(500)
              .fadeIn(500)
              .fadeOut(500)
              .fadeIn(500);
        ...
        if (
          ...
          $(this).parent().parent().find(".password").hasClass("password")
        ) {
          if (
            $.trim($(this).val()) !=
            $.trim($(this).parent().parent().find(".password").val())
          ) {
            $(this)
              .parent()
              .find(".password")
